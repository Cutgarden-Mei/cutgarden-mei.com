		...
		items: [
			{
				...
				price: "¥5,500",
				duration: "60 min",
				description: "骨格と髪質に合わせて、扱いやすいスタイルへ整えます。",
			},
			{
				name: "前髪カット",
				price: "¥1,100",
				duration: "15 min",
				description: "少しの変化で印象を整えるメンテナンスメニュー。",
			},
		],
	},
	{
		...
		items: [
			{
				...
				price: "¥7,700",
				duration: "90 min",
				description: "ライフスタイルに合わせて色持ちの良いカラーを提案します。",
			},
			{
				name: "リタッチカラー",
				price: "¥6,600",
				duration: "75 min",
				description: "根元のみを整えたい方向けのメニューです。",
			},
		],
	},
	{
		...
		items: [
			{
				...
				price: "¥4,400",
				duration: "30 min",
				description: "髪の状態に応じたケアで、まとまりやすさを高めます。",
			},
		],
	},
];
...
export const voices: Voice[] = [
	{
		...
		menuLabel: "カット + カラー",
		comment:
			"雰囲気を大きく変えずに、今っぽい軽さを出してもらえました。お店も落ち着いていて通いやすいです。",
		staffSlug: "mei",
	},
	{
		customerName: "Mさま",
		...
		comment:
			"相談しながら進めてくれるので安心感があり、毎回ちょうど良い仕上がりになります。",
		staffSlug: "mei",
	},
];
...
export const accessInfo: AccessInfo = {
	...
	mapEmbedUrl:
		"https://www.google.co.jp/maps/place/%E3%82%AB%E3%83%83%E3%83%88%E3%82%AC%E3%83%BC%E3%83%87%E3%83%B3Mei/@34.6197191,135.5536154,17z/data=!3m1!4b1!4m2!3m1!1s0x0:0xbc62f72ae153bbef",
	directions: [
...
export const contactSettings: ContactSettings = {
	...
	thanksMessage:
		"お問い合わせありがとうございます。通常2営業日以内にご返信します。",
	privacyPolicyUrl: "/privacy-policy",
	autoReplySubject: "お問い合わせありがとうございます | CUT GARDEN MEI",
	autoReplyBody:
		"このたびはお問い合わせいただきありがとうございます。内容を確認のうえ、担当者よりご連絡いたします。",
};
